  ...
  <div class="container container--shadow" v-if="chest._id">
    ...
    <section class="chest__header">
      <div class="chest__image">
        <img v-if="chest.name === 'Season Reward Chest'" src="./../media/chest.png" :alt="chest.name+' image'">
        <img v-else :src="'http://www.clashapi.xyz/images/chests/'+chest.url+'.png'" :alt="chest.name+' image'">
      </div>
